...
public class RolesJpaController implements Serializable {
    ...
    public void create(Roles roles) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            for (Usuarios usuariosListUsuariosToAttach : roles.getUsuariosList()) {
                usuariosListUsuariosToAttach = em.getReference(usuariosListUsuariosToAttach.getClass(), usuariosListUsuariosToAttach.getDni());
            ...
            if (findRoles(roles.getClave()) != null) {
    ...
    public void edit(Roles roles) throws NonexistentEntityException, Exception {
        ...
        try {
            em = getEntityManager();
            em.getTransaction().begin();
            Roles persistentRoles = em.find(Roles.class, roles.getClave());
            ...
            for (Usuarios usuariosListNewUsuariosToAttach : usuariosListNew) {
                usuariosListNewUsuariosToAttach = em.getReference(usuariosListNewUsuariosToAttach.getClass(), usuariosListNewUsuariosToAttach.getDni());
